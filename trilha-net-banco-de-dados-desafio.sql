...
--- resolução trilha-net-banco-de-dados-desafio (DIO) ---
...
-- 9 Buscar os Atores do gnero feminino, retornando o PrimeiroNome, UltimoNome, e ordenando pelo PrimeiroNome 
...
SELECT a.Nome as NomeFilme, b.Genero as Genero from Filmes a INNER JOIN FilmesGenero c ON a.Id = c.IdFilme INNER JOIN Generos b ON c.IdGenero = b.Id;
